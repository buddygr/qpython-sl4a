...
def imageCompress(self,srcPath,destPath,targetByteSize=0,targetWidth=0,targetHeight=0,targetFormat="JPEG"):
    return self._rpc("imageCompress",srcPath,destPath,targetByteSize,targetWidth,targetHeight,targetFormat)

def editorOpen(self, path):
    return self._rpc("editorOpen", path)

def startService(self,action,uri=None,type=None,extras=None,isForeground=False,packagename=None,classname=None,flags=None):
    return self._rpc("startService",action,uri,type,extras,isForeground,packagename,classname,flags)

def startServiceIntent(self,intent,isForeground=False):
    return self._rpc("startServiceIntent",intent,isForeground)

def stopService(self,action,uri=None,type=None,extras=None,packagename=None,classname=None,flags=None):
    return self._rpc("stopService",action,uri,type,extras,packagename,classname,flags)

def stopServiceIntent(self,intent):
    return self._rpc("stopServiceIntent",intent)

def startApp(self, packagename, wait = True):
    return self._rpc("startApp",packagename,wait)

def executeQPyCode(self,code=""):
    return self._rpc("executeQPyCode",code)
