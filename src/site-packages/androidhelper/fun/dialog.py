...
def dialogGetPassword(self,title="Password",message="Please enter password:",messageIsHtml=False):
    return self._rpc("dialogGetPassword",title,message,messageIsHtml)
