...
def documentTreeListAll( self ):
    self._addClass('documentFile')
    return self.documentTreeListAll()

def termuxStartService(self, virtualRoot = '/com.termux'):
    self._addClass('termux')
    return self.termuxStartService(virtualRoot)
